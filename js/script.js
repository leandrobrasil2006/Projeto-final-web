...
function calculadoraImc() {
    ...
    if (imc < 18.5) {
        ...
        classTxt.innerHTML = 'Abaixo de peso'
        ...
        secResult.classList.add('viewResult')
        imcTxt.innerHTML = imc
        classTxt.innerHTML = 'Peso está normal'
        ...
        secResult.classList.add('viewResult')
        imcTxt.innerHTML = imc
        classTxt.innerHTML = 'Obesidade de grau 1'
        btnE.style.display = 'none'
        btnM.style.display = 'none'
        btnI.style.display = 'flex'
        ...
        secResult.classList.add('viewResult')
        imcTxt.innerHTML = imc
        classTxt.innerHTML = 'Obesidade de grau 2'
        btnE.style.display = 'none'
        btnM.style.display = 'none'
        btnI.style.display = 'flex'
        ...
        secResult.classList.add('viewResult')
        imcTxt.innerHTML = imc
        classTxt.innerHTML = 'Obesidade de grau 3'
        btnE.style.display = 'none'
        btnM.style.display = 'none'
        btnI.style.display = 'flex'
